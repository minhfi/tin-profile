...
import { STCircle, STCompany, STCompanyBanner, STCompanyItem, STCompanyWrapped, STContainer, STSection, STThreeDots } from './styled'
...
export const Company: FC = () => {
  ...
  return (
    <STContainer>
      <Title number="03" title="MY COMPANY"/>
      <STSection>
        <SwitchTransition>
          <CSSTransition
            key={slide}
            ...
            <>
              {slide === 0 && (
                <STCompany>
                  <STCompanyBanner>
                    <Box>
                      <Typography variant="body1">2016 - 2017</Typography>
                      <Typography variant="sbutitle3">
                        We Love
                        UI/UX Design
                      </Typography>
                    </Box>
                  ...
                  <STCompanyWrapped>
                    <STCompanyItem>
                      <Box>
                        ...
                        <Typography variant="h4">ARR - an viet song hong</Typography>
                        <Typography variant="body2" lineHeight="22px">{t('company_anvietsonghong_content1')}.</Typography>
                      </Box>
                      <Box>
                    ...
                    <STCompanyItem>
                      <Box>
                        ...
                        <Typography variant="h4">kem nghia</Typography>
                        <Typography variant="body2" lineHeight="22px">{t('company_kemnghia_content1')}</Typography>
                      </Box>
                      <Box>
                    ...
                    <STCompanyItem mt={1.5}>
                      <Box>
                        ...
                        <Typography variant="body2" lineHeight="22px" letterSpacing="0.2px">{t('company_matbao_content1')}</Typography>
                    ...
                    <STCompanyItem mt={1.5}>
                      <Box>
                        ...
                        <Typography variant="h4">VIET TIEN LAB GROUP</Typography>
              ...
              {slide === 1 && (
                <STCompany>
                  <STCompanyBanner>
                    <Box>
                      <Typography variant="body1">2018 - 2021</Typography>
                      <Typography variant="sbutitle3">
                        We Love
                        UI/UX Design
                      </Typography>
                  ...
                  <STCompanyWrapped>
                    <STCompanyItem>
                      <Box>
                        <Typography variant="body2">UI/UX Design</Typography>
                        <Typography variant="h4">GMarks viet nam</Typography>
                        <ul>
                    ...
                    <STCompanyItem>
                      <Box>
                        <Typography variant="body2">UI/UX Design</Typography>
                        <Typography variant="h4">Propzy</Typography>
                    ...
                    <STCompanyItem mt={1.5}>
                      <Box>
                        <Typography variant="body2">Collaborators UI</Typography>
                        <Typography variant="h4">ocb - Oricombank</Typography>
                    ...
                    <STCompanyItem mt={1.5} width={301}>
                      <Box>
                        ...
                        <Typography variant="h4">sTA - TECHNOLOGY & APPLICATION</Typography>
              ...
              {slide === 2 && (
                <STCompany>
                  <STCompanyBanner>
                    <Box>
                      <Typography variant="body1">2021 - 2023</Typography>
                      <Typography variant="sbutitle3">
                        We Love
                        UI/UX Design
                      </Typography>
                  ...
                  <STCompanyWrapped>
                    <STCompanyItem height={360}>
                      <Box>
                        ...
                        <Typography variant="h4">Dinovative</Typography>
